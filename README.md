...
The links in the descriptions below can be used to access more documentation in the form of additional readme.md files that go more in-depth about the tool, how to install it, and how to use.
...
A Galaxy tool designed to take the ZIP archive generated by the HybPiper Galaxy tool above, and extract the sequence files (with options for FNA, FAA and intron sequence files) to be used in further the creation of Multiple Sequence Alignments (MSA's).
